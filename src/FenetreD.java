    ...
    public FenetreD() {
        ...
        for (int i=0;i<4;i++){
            ...
            if(i==0){
                ...
                if(i==1) {
                    tableaumenu[i].setLocation(Panneausysteme.getWidth() /4, Panneausysteme.getHeight()/2-50); //composant de gauche
                    estvertical[i]=true;
                    tableauzonetexte[i]=tableaumenu[i].saisie; //on met le Jtext field du itemcomposant dans un tableau
                    tableauzonetexte[i].addKeyListener(new KeyAdapter() {
                ...
                if(i==2){
                    tableaumenu[i].setLocation((int)(Panneausysteme.getWidth()*0.55),Panneausysteme.getHeight()/2-50); //composant du milieu
                    estvertical[i]=true;
                    tableauzonetexte[i]=tableaumenu[i].saisie; //on met le Jtext field du itemcomposant dans un tableau
                    tableauzonetexte[i].addKeyListener(new KeyAdapter() {
                        public void keyTyped(KeyEvent e) { //on n'autorise que l'ecriture des chiffres
                ...
                if(i==3){
                    tableaumenu[i].setLocation(Panneausysteme.getWidth()-180,Panneausysteme.getHeight()/2-50); // composant de droite
                    estvertical[i]=true;
                    tableauzonetexte[i]=tableaumenu[i].saisie; //on met le Jtext field du itemcomposant dans un tableau
                    tableauzonetexte[i].addKeyListener(new KeyAdapter() {
                        public void keyTyped(KeyEvent e) { //on n'autorise que l'ecriture des chiffres
        ...
        for (int j=0;j<tab.length;j++) {
            ...
            if(tab[j].getItem()=="Résistance"){
                ...
                if(tab1[j]==true){
                    ...
                    jlabel.setBounds(tab[j].getX()+27,tab[j].getY(),50,300);
                }
            ...
            if(tab[j].getItem()=="Bobine"){
                ...
                if(tab1[j]==true){
                    tourneimage(90,jlabel,icone);
                    jlabel.setBounds(tab[j].getX()+33,tab[j].getY(),50,300);
                }
